...
class vidi:
	...
	def setup(self):
		...
		tk.Radiobutton(self.settingsframe, text="Gauss Filter", variable=gauss, value = True).grid(row=2, column = 0, sticky=(tk.W))
		tk.Radiobutton(self.settingsframe, text="Threshhold Filter", variable=gauss, value = False).grid(row=3, column = 0, sticky=(tk.W))
